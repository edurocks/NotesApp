...
@HiltViewModel
class AuthViewModel @Inject constructor(private val noteRepository: NoteRepository) : ViewModel() {
    ...
    fun register(email: String, password: String, repeatedPassword: String) {
        ...
        viewModelScope.launch {
            val result = noteRepository.register(email, password)
    ...
    fun login(email: String, password: String) {
        ...
        viewModelScope.launch {
            val result = noteRepository.login(email, password)
